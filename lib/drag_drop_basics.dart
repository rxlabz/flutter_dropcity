...
class _DragBoxState extends State<DragBox> {
  ...
  Widget build(BuildContext context) {
    return new Stack(children: [
      new DraggableText('A', new Offset(20.0, 100.0)),
      new DraggableText('B', new Offset(140.0, 100.0)),
      new Positioned(
          left: 40.0,
          bottom: 40.0,
...
class _DraggableTextState extends State<DraggableText> {
  ...
  @override
  Widget build(BuildContext context) {
    final item = new LabelBox(size: new Size.square(150.0), label: widget.text);
